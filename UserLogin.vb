...
Public Class UserLogin
    ...
    Private Sub btnLogin_Click(sender As Object, e As EventArgs) Handles btnLogin.Click
        Try
            ...
            Else
                ...
                If reader.Read Then
                    MsgBox(" Logged in Successfully as User!", MessageBoxButtons.OK, MessageBoxIcon.Information)
                    Me.Close()
                    Login.Visible = False
                    UserEnd.Visible = True
                Else
    ...
    Private Sub btnCancel_Click(sender As Object, e As EventArgs) Handles btnCancel.Click
        Dim response As DialogResult = MessageBox.Show(" Do you wat to exit the User Log in?", " Close", MessageBoxButtons.YesNo,
